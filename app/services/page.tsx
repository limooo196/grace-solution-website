      ...
      <div className="ml-3/12 lg:mt-3 md:mt-12 xl:px-60 sm:px-10 xl:w-10/12  mx-auto flex justify-center items-center">
        <div className="bg-gray-300 xl:w-9/12   h-96 xl:h-80 flex flex-row flex-grow rounded-lg ">
          <div className=" w-9/12 m-5 p-8 ">
            ...
            <button
              type="button"
              className="text-white md:mt-10 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
            >
